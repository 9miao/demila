	...
	function getScrolltopHtml(opt, mobile){
		...
		//if(!mobile){
			...
			for(var i = 0, len = qqs.length; i < len; i++){
				tmp += "<li><a href='http://wpa.qq.com/msgrd?v=3&uin=" + qqs[i] + "&site=qq&menu=yes' target='_blank'><div class='sidebox'><img src='/static/home/default/img/custom/icon04.png'>联系我们</div></a></li>";
			}
