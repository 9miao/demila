...
(function($) {
	...
	$.color.make = function(G, H, J, I) {
		...
		A.clone = function() {
			return $.color.make(A.r, A.b, A.g, A.a)
		};
		return A.normalize()
	};
	$.color.extract = function(E, F) {
		var A;
		do {
			...
			E = E.parent()
		} while (!$.nodeName(E.get(0), "body"));
		if (A == "rgba(0, 0, 0, 0)") {
			A = "transparent"
		}
		return $.color.parse(A)
	};
	...
	function B(l, W, X, E) {
		...
		function m() {
			var AW = Number.POSITIVE_INFINITY,
				...
				Ac, Aa, AZ, AV, AL, AR, Ab, AX, AP, AO, AK, Ai, Af, AT;
			for (AK in s) {
				s[AK].datamin = AW;
				s[AK].datamax = AQ;
				s[AK].used = false
